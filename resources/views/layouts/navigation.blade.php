<nav x-data="{ open: false }" class="bg-black border-b border-gray-100 fixed top-0 left-0 right-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('characters.index')" :active="request()->routeIs('characters.index')" class="text-white">
                        {{ __('Characters') }}
                    </x-nav-link>
